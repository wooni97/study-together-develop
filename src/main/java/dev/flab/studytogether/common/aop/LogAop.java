package dev.flab.studytogether.common.aop;
...
public class LogAop {
    ...
    Post 요청 로깅
     */
    @Pointcut("@annotation(dev.flab.studytogether.common.aop.PostMethodLog)")
    ...
    Get 요청 로깅
     */
    @Pointcut("@annotation(dev.flab.studytogether.common.aop.GetMethodLog)")
